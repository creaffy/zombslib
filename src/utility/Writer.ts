...
export class BufferWriter {
    ...
    i64(v: bigint, le: boolean = true) {
        this.resize(8);
        this.view.setBigInt64(this.offset, v, le);
        this.offset += 8;
    }

    u64(v: bigint, le: boolean = true) {
        this.resize(8);
